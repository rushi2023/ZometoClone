...
import NextArrow from "../../common/carousel/nextAroow";
...
const TopBrend = () => {
  return (
    <div className="top-brend max-width">
      <div className="collection-title">Top Brend for you</div>
      <Slider {...settings}>
          {topBrandsList.map((brend)=>{
              return<div>
                  <div className="top-brend-cover">
                  <img     src={brend.cover} className='top-brend-img' />
                  </div>
              </div>
          })}
      </Slider>
